...
A project made to simulate the 72 group stage matches and the knockout matchups of the 2026 FIFA World Cup
...
Try it out yourself at: https://fifa26.atharva02.hackclub.app/
...
* Knockout Page
  * Interactive bracket feature to simulate your own bracket
  * Lock matchups after the occur in real time
  * View advancement probabilities of each team to finish at each part of the bracket
