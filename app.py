...
knockout_actual_scores = {
    ...
    ('France', 'Sweden'): (3, 0, 'H', False, 0, 0),
    ('Mexico', 'Ecuador'): (2, 0, 'H', False, 0, 0),
    ...
    ('Australia', 'Egypt'): (1, 1, 'A', True, 2, 4),
    ('Argentina', 'Cape Verde'): (3, 2, 'H', False, 0, 0),
    ('Colombia', 'Ghana'): (1, 0, 'H', False, 0, 0),
    ('Canada', 'Morocco'): (0, 3, 'A', False, 0, 0),
    ('Paraguay', 'France'): (0, 1, 'A', False, 0, 0),
    ('Brazil', 'Norway'): (1, 2, 'A', False, 0, 0),
    ...
    ('Switzerland', 'Colombia'): (0, 0, 'H', True, 4, 3),
    ('France', 'Morocco'): (2, 0, 'H', False, 0, 0),
    ...
    ('England', 'Argentina'): (1, 2, 'A', False, 0, 0),
    ('France', 'England'): (4, 6, 'A', False, 0, 0),
    ('Spain', 'Argentina'): (1, 0, 'H', False, 0, 0),
}
